package de.libutzki.xtext.nodemodeloutline.ui.view;
...
public class NodeModelOutline extends PageBookView {
	...
	protected IPage createDefaultPage(PageBook book) {
        ...
        page.setMessage("A node model outline is not available.");
        return page;
	}
